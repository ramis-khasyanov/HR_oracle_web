...
class CandidateForm(FlaskForm):
    ...
    e_position_eng = StringField('Должность', validators=[DataRequired()], default="DC_employee")
    e_salary_base = StringField("Фиксированный оклад", validators=[DataRequired()], default=10500)
    e_days_to_hire = StringField('Дней прошло с первого контакта', validators=[DataRequired()], default=35)
    e_entrance_type = StringField('Кто нашел', validators=[DataRequired()], default=1)
    e_source = StringField('Источник', validators=[DataRequired()], default="headh")
